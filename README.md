...
El contenido de este correo electrónico y sus posibles archivos adjuntos es confidencial y está destinado exclusivamente a la persona o entidad a la que se dirige. Si usted ha recibido este mensaje por error, le solicitamos notificarlo al remitente y eliminarlo de inmediato. Queda estrictamente prohibido copiar, reenviar o divulgar su contenido sin autorización. Este mensaje puede contener información sensible relacionada con estudiantes, colaboradores o procesos institucionales, protegida por las leyes de privacidad y de protección de datos vigentes. 🌱 Por favor, considere el medio ambiente antes de imprimir este correo electrónico.

Es posible que estés sin conexión o con conectividad limitada. Prueba a descargar el contenido.